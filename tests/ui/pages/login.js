...
class LoginPage {
    constructor(page) {
       ...
       this.invalidCredMsg=page.getByText("Invalid credentials",{ exact : true });
       this.requiredMsg=page.getByText("Required", { exact: true })
...
//Navigate the login page
      ...
      await this.page.waitForURL(this.url,"load")
